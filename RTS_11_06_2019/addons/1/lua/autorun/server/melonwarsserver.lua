...
net.Receive( "MW_SelectContraption" , function(len, pl)
	print("Server received selection request")
	...
	print("Returning extra selection to the client ("..extraCount.." extra entities)")
...
net.Receive( "MW_SpawnProp", function( len, pl )
	...
	MW_SpawnProp(mw_base_props[index].model, trace.HitPos + trace.HitNormal + offset, propAngle + mw_base_props[index].angle, _team, trace.Entity, cost, pl, spawntime)
end )

function MW_SpawnProp(model, pos, ang, _team, parent, cost, pl, spawntime)
