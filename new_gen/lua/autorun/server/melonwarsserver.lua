...
resource.AddFile("materials/RTS_MelonWars/JetPack.jpg")
resource.AddFile("materials/RTS_MelonWars/Артиллерийское_депо.jpg")
resource.AddFile("materials/RTS_MelonWars/Базутчик.jpg")
resource.AddFile("materials/RTS_MelonWars/Батарея_Б.jpg")
resource.AddFile("materials/RTS_MelonWars/Батарея_М.jpg")
resource.AddFile("materials/RTS_MelonWars/Батарея_С.jpg")
resource.AddFile("materials/RTS_MelonWars/Башня_тесла.jpg")
resource.AddFile("materials/RTS_MelonWars/Большие_ворота.jpg")
resource.AddFile("materials/RTS_MelonWars/Большой_столб.jpg")
resource.AddFile("materials/RTS_MelonWars/Военный_завод.jpg")
resource.AddFile("materials/RTS_MelonWars/Воздушные_войска.jpg")
resource.AddFile("materials/RTS_MelonWars/Ворота.jpg")
resource.AddFile("materials/RTS_MelonWars/Госпиталь.jpg")
resource.AddFile("materials/RTS_MelonWars/Казармы_базутчики.jpg")
resource.AddFile("materials/RTS_MelonWars/Казармы_медики.jpg")
resource.AddFile("materials/RTS_MelonWars/Казармы_пехота.jpg")
resource.AddFile("materials/RTS_MelonWars/Казармы_пулемётчики.jpg")
resource.AddFile("materials/RTS_MelonWars/Казармы_снаперы.jpg")
resource.AddFile("materials/RTS_MelonWars/Казармы_шахиды.jpg")
resource.AddFile("materials/RTS_MelonWars/Лифт.jpg")
resource.AddFile("materials/RTS_MelonWars/Медик.jpg")
resource.AddFile("materials/RTS_MelonWars/Миномёт.jpg")
resource.AddFile("materials/RTS_MelonWars/Паровой_двигатель.jpg")
resource.AddFile("materials/RTS_MelonWars/Пехота.jpg")
resource.AddFile("materials/RTS_MelonWars/Пулемётчик.jpg")
resource.AddFile("materials/RTS_MelonWars/Радар.jpg")
resource.AddFile("materials/RTS_MelonWars/Снайпер.jpg")
resource.AddFile("materials/RTS_MelonWars/Солнечная_батарея.jpg")
resource.AddFile("materials/RTS_MelonWars/Столб.jpg")
resource.AddFile("materials/RTS_MelonWars/Тумблер.jpg")
resource.AddFile("materials/RTS_MelonWars/Турель.jpg")
resource.AddFile("materials/RTS_MelonWars/Ускоритель.jpg")
resource.AddFile("materials/RTS_MelonWars/Шахид.jpg")
resource.AddFile("materials/RTS_MelonWars/Шредер.jpg")
resource.AddFile("materials/RTS_MelonWars/Ядерная_бомба.jpg")
resource.AddFile("materials/RTS_MelonWars/Ядерная_шахта.jpg")
resource.AddFile("materials/RTS_MelonWars/Ядерный_реактор.jpg")
...
local function StartGame( len, pl )
	for k, v in pairs( player.GetAll() ) do
		...
		--MelonPlaySound(v, "rts_music/" .. math.random(1,16) .. ".mp3")
