...
CreateConVar ( "mw_save_name", "melonwars/2_player_high.txt", 8192, "Set the name of the file to save with 'mw_save'" )
...
hook.Add("PlayerSay", "MelonPlayerSay", function(pl, text, team)
	if (text:lower() == "!start") then
		RunConsoleCommand( "mw_admin_playing", "1" )
		sound.Play( "garrysmod/content_downloaded.wav", pl:GetPos(), 60, 90, 1 )
	elseif (text:lower() == "!stop") then
		sound.Play( "garrysmod/content_downloaded.wav", pl:GetPos(), 60, 90, 1 )
		RunConsoleCommand( "mw_admin_playing", "0" )
	end
end)
